...
RSpec.describe User, type: :model do
  it 'Creates a three valid post for a user and gets them from a database' do
    ...
    first_post = Post.create!(author: user, title: 'Post title', text: 'This is my first post', comments_counter: 0,
                              likes_counter: 0)
    second_post = Post.create!(author: user, title: 'I love Valent', text: 'Valent is my purest love',
                               comments_counter: 0, likes_counter: 0)
    third_post = Post.create!(author: user, title: 'Aku cinta Valent', text: 'Aku mencintaimu Valent',
                              comments_counter: 0, likes_counter: 0)
